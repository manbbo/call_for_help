...
class cadastroPesqPage extends StatefulWidget {
  @override
  _cadastroPesqPageState createState() => _cadastroPesqPageState();
}

class _cadastroPesqPageState extends State<cadastroPesqPage> {
  bool changed = false;
  @override
